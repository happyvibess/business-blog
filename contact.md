...
<div class="container mx-auto px-4 py-12">
  <div class="max-w-3xl mx-auto">
    ...
    <div class="mt-12 text-center">
      ...
      <p class="text-gray-600 mb-4">Follow us on social media or support our work</p>
      <div class="flex justify-center space-x-4">
        <a href="https://github.com/happyvibess" class="text-gray-400 hover:text-gray-600">
        ...
        <a href="https://www.buymeacoffee.com/happyvibess" class="text-gray-400 hover:text-gray-600">
